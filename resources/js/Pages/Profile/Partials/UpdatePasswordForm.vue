...
<template>
	<section>
		<header>
			...
			<p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Asegúrate que tu contraseña sea larga y contenga alfanuméricos para asegurar tu cuenta.</p>
		</header>
		...
		<form @submit.prevent="updatePassword" class="mt-6 space-y-6">
			...
			<div class="flex items-center gap-4">
				...
				<Transition enter-from-class="opacity-0" leave-to-class="opacity-0" class="transition ease-in-out">
					<p v-if="form.recentlySuccessful" class="text-sm text-gray-600 dark:text-gray-400">Contraseña actualizada</p>
				</Transition>
			</div>
		</form>
	</section>
